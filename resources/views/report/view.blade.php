            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-end mb-3">
                        <a href="{{ route('admin.player.index') }}" class="btn btn-danger " style="width: 100px;"><i class="fas fa-arrow-left mr-2" ></i> Back</a>
                    </div>
                    <div class="card " style="border-radius: 20px;">
                        <div class="card-header">
                            <h3>Win/lose Reports</h3>
                        </div>
                                ...
                                <div class="container">
                                    <form action="">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 pt-lg-1">
                                                <button class="btn btn-sm btn-primary mt-3 " id="search">Search</button>
                                            </div>
